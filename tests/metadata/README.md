...
do xmlsec1 --sign --insecure --privkey-pem src/spid_sp_test/idp/private.key --id-attr:ID urn:oasis:names:tc:SAML:2.0:metadata:EntityDescriptor `echo $i | sed -e s'/_signed//g'` > $i;
