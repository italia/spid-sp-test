...
class SpidSpMetadataCheckPublic(object):
    def test_Contacts_PubPriv(self, contact_type:str="other", entity_type:str=None):
        ...
        self._assertTrue(
            ...
            test_id = ['01.10.0','01.13.0','01.17.00','01.17.01'], **_data,
        )

        return self.is_ok(_method)

    def test_Extensions_PubPriv(self, contact_type:str="other", entity_type:str=None, org_chk=True ):
        ...
        for cont in _conts:
            ...
            self._assertFalse(
                ...
                test_id = ['01.10.01','01.13.01','01.17.02',], **_data,
            )
        ...
        if len(orgs) >= 1:
            ...
            if company:
                ...
                self._assertFalse(
                    entity_type == "spid:aggregator" or entity_type == "spid:aggregated"  ,
                    f"The Company element MUST be present {entity_type}",
                    test_id = ['01.17.03'], **_data
                )

        return self.is_ok(_method)

    def test_contactperson_email(self, contact_type:str="other", entity_type:str=None): 
        ...
        if email:
            ...
            self._assertFalse(
                ...
                description=[etree.tostring(_val).decode() for _val in email],
                test_id = ['01.10.04','01.13.04','01.17.06'], **_data,
            )

        return self.is_ok(_method)

    def test_contactperson_phone(self,contact_type:str="other", entity_type:str=None):
        ...
        if phone :
            ...
            self._assertTrue(
                ...
                description=phone,
                test_id = ['01.10.07','01.17.09'], **_data,
            )
            self._assertTrue(
                (" " not in phone),
                f"The {phone_xpath} element MUST not contain spaces",
                description=phone,
                test_id = ['01.10.08','01.17.10'], **_data,
            )
            self._assertTrue(
                (phone[0:3] == "+39"),
                ...
                description=phone,
                level="warning",
                test_id = ['01.10.09','01.17.11'], **_data,
            )

        return self.is_ok(_method)

    def test_Contacts_IPACode(self,contact_type:str="other",entity_type:str=None,public=False,private=False):
...
#            )
            if ipacode:
                ...
                self._assertTrue(
                    ...
                    test_id = ['01.11.03','01.17.13'], **_data
                )
                ...
                self._assertTrue(
                    ...
                    test_id = ['01.11.04','01.17.14'], **_data,
                )
            else :
                self._assertFalse(
    ...
    def test_Contacts_VATFC(self, contact_type:str="other", entity_type:str=None, private=False, must=False):
